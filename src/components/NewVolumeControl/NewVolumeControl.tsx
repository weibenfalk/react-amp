...
// Styles
import { Wrapper } from './NewVolumeControl.styles';
...
const NewVolumeControl = ({ volume, setVolume, isDraggingVolume, setIsDraggingVolume, className }: Props) => {
...
export default NewVolumeControl;
